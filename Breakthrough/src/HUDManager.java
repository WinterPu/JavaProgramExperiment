...
public class HUDManager {
	...
	public void updateShowShipHp() {
		...
		if (ship == null)
			...
			if (hearts.size() == 0) {
				gm.gameStatus = GameManager.GameStatus.LOSE;
				return;
			}
		}
	}
	...
	public void showShipBulletNum() {
		...
		textBulletNum
				.setX(bulletIcon.getCharacterX() + bulletIcon.getWidth() + HUD_BASE * 2.5 + heartIcon.getWidth() / 4.0);
	...
	private void initWinAndLoseView() {
		...
		if (gm.gameStatus == GameManager.GameStatus.LOSE) {
